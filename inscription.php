...
<body>
    ...
    <div class="container mt-4">
        <h1>Inscription</h1>
        <form id="inscriptionForm" action="submit_inscription.php" method="post" onsubmit="return validateForm()">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="type_utilisateur_id" name="type_utilisateur_id" required>
            </div>
